...
const customerServiceTranslations: Record<LanguageCode, {
  ...
  en: {
    ...
    faqA1: "All yield balance payouts are processed automatically via Commercial Bank of Ethiopia (CBE) institutional API integration within 2 to 6 hours after withdrawal requests are placed.",
  ...
  am: {
    ...
    faqA1: "ሁሉም የትርፍ ክፍያዎች በኢትዮጵያ ንግድ ባንክ (CBE) ተቋማዊ ኤፒአይ በኩል ከ2 እስከ 6 ሰዓት ባለው ጊዜ ውስጥ በራስ-ሰር ይከፈላሉ ።",
  ...
  om: {
    ...
    faqA1: "Kaffaltiin bu'aa hundi Commercial Bank of Ethiopia (CBE) API sirnaan sa'aatii 2 hanga 6 keessatti of-umaan raawwatama.",
  ...
  ti: {
    ...
    faqA1: "ኮሎም ክፍሊታት ብናይ ኢትዮጵያ ንግዲ ባንኪ (CBE) ኤፒአይ ኣቢሎም ካብ 2 ክሳብ 6 ሰዓታት ውሽጢ ብባዕሎም ይፍጸሙ እዮም።",
  ...
  so: {
    ...
    faqA1: "Dhamaan bixinta faaiidooyinka waxaa si toos ah loo farsameeyaa iyada oo loo marayo Commercial Bank of Ethiopia (CBE) muddo 2 ilaa 6 saacadood gudahood ah.",
