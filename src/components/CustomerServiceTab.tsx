...
const customerServiceTranslations: Record<LanguageCode, {
  ...
  en: {
    ...
    faqA2: "The minimum deposit amount is 1000 ETB. The minimum withdrawal is 200 ETB to guarantee efficient network settlement with CBE without excessive service charges.",
  ...
  am: {
    ...
    faqA2: "ዝቅተኛው የተቀማጭ መጠን 1000 ETB ነው፣ ዝቅተኛው የማውጫ መጠን ደግሞ 200 ETB ነው። ይህ የሆነው ያለ አላስፈላጊ የአገልግሎት ክፍያ ግብይቱን ለማሳለጥ ነው።",
  ...
  om: {
    ...
    faqA2: "Maallaqni galii xiqqaan 1000 ETB dha. Kaffaltiin baasii xiqqaan immoo 200 ETB dha, kunis kaffaltii tajaajila dabalataa malee herrega salphisuufi.",
  ...
  ti: {
    ...
    faqA2: "ዝተሓተ መጠን ተቀማጭ 1000 ETB ክኸውን ከሎ፣ ዝተሓተ መጠን ምስሓብ ድማ 200 ETB እዩ። እዚ ድማ ክፍሊት ኣገልግሎት ንምንካይ እዩ።",
  ...
  so: {
    ...
    faqA2: "Deebaajiga ugu yar waa 1000 ETB. Lacag bixinta ugu yar ee la oggol yahayna waa 200 ETB si loo hubiyo degdeg bixinta deebaajiga.",
