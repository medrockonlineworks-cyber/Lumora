...
1. **Deposit Micro-Capital Instantly**: Copy our official Commercial Bank of Ethiopia (CBE) account number from the Deposit Dialog. Transfer your starting capital (minimum 1,000 ETB) from your CBE Birr App, note down your reference code, and capture a clear screenshot of the receipt. You can construct and submit deposit proof instantly without needing to verify your ID first.
...
2. **ግብይት ገደቦች**: ዝቅተኛው ተቀማጭ ገንዘብ 1000 ETB እና አነስተኛው የገንዘብ ማውጣት 200 ETB ነው።
...
2. **Daangaa Maallaqaa**: Kaffaltiin gadi aanaan herrega galchuu 1000 ETB, herrega baasuu immoo 200 ETB dha.
...
2. **ገደብ ገንዘብ**: ዝቅተረ ዝግበር ተቀማጦ 1000 ETB ክኸውን ከሎ ዝቅተረ ገንዘብ ምውጻእ ድማ 200 ETB እዩ።
