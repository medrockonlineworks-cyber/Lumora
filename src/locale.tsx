...
export const translations: Record<LanguageCode, Translations> = {
  en: {
    ...
    withdrawalTimeLimit: 'Official Withdrawal Hours: Every day from 3:00 AM to 12:00 PM (Noon), Local Time',
    withdrawalTimeError: 'Withdrawals are restricted to official local hours: Every day from 3:00 AM to 12:00 PM (Noon), Local Time. Please request during official hours.',
    ...
    howToWithdrawGuide4: 'Authorization & Queue: Click "Authorize Secure Withdrawal". Our manual audit desk processes all requests sequentially within 1-2 hours. Note: Withdrawals are processed only during official hours (Every day from 3:00 AM to 12:00 PM (Noon), Local Time).',
  ...
  am: {
    ...
    withdrawalTimeLimit: 'ኦፊሴላዊ የገንዘብ ማውጫ ሰዓታት፡ በየቀኑ ከጠዋቱ 3:00 AM እስከ 12:00 PM (ቀን/ቀትር) የሀገር ውስጥ ሰዓት (በኢትዮጵያ አቆጣጠር ከሌሊቱ 9:00 እስከ ቀኑ 6:00)',
    withdrawalTimeError: 'የገንዘብ ማውጫ ከተፈቀደው የጊዜ ሰሌዳ ውጭ ተገድቧል፡ በየቀኑ ከጠዋቱ 3:00 AM እስከ 12:00 PM (ቀን/ቀትር) የሀገር ውስጥ ሰዓት (በኢትዮጵያ አቆጣጠር ከሌሊቱ 9:00 እስከ ቀኑ 6:00) ብቻ ነው የሚፈቀደው። እባክዎ በተፈቀደው ሰዓት ይጠይቁ።',
    ...
    howToWithdrawGuide4: 'ፈቃድ እና መስመር፡ "ገንዘብ አውጣ" የሚለውን ይጫኑ። የኦዲት ባለሙያዎቻችን በ1-2 ሰዓታት ውስጥ ያረጋግጣሉ። ማሳሰቢያ፡ ገንዘብ ማውጣት የሚቻለው በኦፊሴላዊ የሥራ ሰዓት (በየቀኑ ከጠዋቱ 3:00 AM እስከ 12:00 PM የሀገር ውስጥ ሰዓት) ብቻ ነው።',
  ...
  om: {
    ...
    withdrawalTimeLimit: 'Sa’aatii Maallaqa Baasuu Rasmicha: Guyyaa guyyaan ganama sa’aatii 3:00 AM hanga waaree booda sa’aatii 12:00 PM (Noon), Sa’aatii Deegaankaa',
    withdrawalTimeError: 'Yeroon maallaqa baasuu rasmichaan ala dhorkameera: Guyyaa guyyaan ganama sa’aatii 3:00 AM hanga waaree booda sa’aatii 12:00 PM (Noon) qofatti hojjeta. Maaloo yeroo rasmichaatti gaafadhaa.',
    ...
    howToWithdrawGuide4: 'Hayyamuufi Hiriira: Tabba "Mirkaneessi" jedhu tuqi. Gareen keenya gaaffii hunda tartiiba sa\'aatii 1-2 keessatti qulqulleessa. Hubachiisa: Maallaqa baasuun sa’aatii rasmichaatti (Guyyaa guyyaan ganama sa’aatii 3:00 AM hanga waaree booda sa’aatii 12:00 PM) qofa raawwatama.',
  ...
  ti: {
    ...
    withdrawalTimeLimit: 'ወግዓዊ ሰዓታት ገንዘብ ምውጻእ፡ መዓልታዊ ካብ ንጉሆ 3:00 AM ክሳብ 12:00 PM (ቀን/ቀትሪ) ናይ ውሽጢ ዓዲ ሰዓት (ካብ ሌሊት 9:00 ክሳብ ቀትሪ 6:00)',
    withdrawalTimeError: 'ምውጻእ ገንዘብ ካብ ፍቑድ ሰዓታት ወጻኢ ተገዲቡ እዩ፡ መዓልታዊ ካብ ንጉሆ 3:00 AM ክሳብ 12:00 PM (ቀን/ቀትሪ) ናይ ውሽጢ ዓዲ ሰዓት (ካብ ሌሊት 9:00 ክሳብ ቀትሪ 6:00) ጥራሕ እዩ ዝፍቀድ። በጃኹም ኣብ ውሽጢ ዝተፈቐደ ሰዓታት ሕተቱ።',
    ...
    howToWithdrawGuide4: 'ምርግጋጽን ተራን፡ "ውሑስ ምውጻእ ፍቐድ" ጠውቑ። ናይ ቁጽጽር ክፍሊና ንኹሎም ሕቶታት በብተራኦም ኣብ ውሽጢ 1-2 ሰዓት ከጻርዮም እዩ። መተሓሳሰቢ፡ ገንዘብ ምውጻእ ኣብ ወግዓዊ ሰዓታት ጥራሕ (መዓልታዊ ካብ ንጉሆ 3:00 AM ክሳብ 12:00 PM ናይ ውሽጢ ዓዲ ሰዓት) ይፍቀድ።',
  ...
  so: {
    ...
    withdrawalTimeLimit: 'Saacadaha rasmiga ah ee la kala baxo: Maalin kasta 3:00 subaxnimo (AM) ilaa 12:00 duhurnimo (PM) waqtiga deegaanka',
    withdrawalTimeError: 'Kala bixista lacagta waxaa lagu xaddiday saacadaha rasmiga ah: Maalin kasta 3:00 subaxnimo (AM) ilaa 12:00 duhurnimo (PM) waqtiga deegaanka. Fadlan codso inta lagu jiro saacadaha rasmiga ah.',
    ...
    howToWithdrawGuide4: 'Oggolaanshaha & Safarka: Guji "Oggolow Kala-Bixitaan Ammaan Ah". Miiska xisaabaadka gacanta ayaa u baara dhammaan codsiyada si isdaba-joog ah 1-2 saacadood gudahood. Xusuusin: Kala bixista waxaa la oggol yahay oo qof saacadaha rasmiga ah (Maalin kasta 3:00 subaxnimo AM ilaa 12:00 duhurnimo PM).',
