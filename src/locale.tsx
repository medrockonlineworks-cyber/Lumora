...
export const translations: Record<LanguageCode, Translations> = {
  en: {
    ...
    withdrawalTimeLimit: 'Official Withdrawal Hours: Daily, 3:00 AM – 12:00 PM (Noon), Local Time (EAT)',
    withdrawalTimeError: 'Withdrawals are restricted to official local hours: Daily, 3:00 AM – 12:00 PM (Noon), Local Time (EAT). Please request during official hours.',
    ...
    howToWithdrawGuide4: 'Authorization & Queue: Click "Authorize Secure Withdrawal". Our manual audit desk processes all requests sequentially within 1-2 hours. Note: Withdrawals are processed only during official hours (Daily, 3:00 AM – 12:00 PM (Noon), Local Time (EAT)).',
  ...
  am: {
    ...
    withdrawalTimeLimit: 'ኦፊሴላዊ የገንዘብ ማውጫ ሰዓታት፡ በየቀኑ ከጠዋቱ 3:00 AM እስከ 12:00 PM (እኩለ ቀን) በሀገር ውስጥ ሰዓት (EAT)',
    withdrawalTimeError: 'የገንዘብ ማውጫ በየቀኑ ከጠዋቱ 3:00 AM እስከ 12:00 PM (እኩለ ቀን) በሀገር ውስጥ ሰዓት (EAT) ብቻ ነው የሚፈቀደው። እባክዎ በተፈቀደው ሰዓት ይጠይቁ።',
    ...
    howToWithdrawGuide4: 'ፈቃድ እና መስመር፡ "ገንዘብ አውጣ" የሚለውን ይጫኑ። የኦዲት ባለሙያዎቻችን በ1-2 ሰዓታት ውስጥ ያረጋግጣሉ። ማሳሰቢያ፡ ገንዘብ ማውጣት የሚቻለው በኦፊሴላዊ የሥራ ሰዓት (በየቀኑ ከጠዋቱ 3:00 AM እስከ 12:00 PM (እኩለ ቀን) በሀገር ውስጥ ሰዓት (EAT)) ብቻ ነው።',
  ...
  om: {
    ...
    withdrawalTimeLimit: 'Sa’aatii Maallaqa Baasuu Rasmicha: Guyyuu, ganama sa’aatii 3:00 AM – galgala sa’aatii 12:00 PM (Noon), Sa’aatii Deegaankaa (EAT)',
    withdrawalTimeError: 'Yeroon maallaqa baasuu guyyuu, ganama sa’aatii 3:00 AM – galgala sa’aatii 12:00 PM (Noon), Sa’aatii Deegaankaa (EAT) qofatti hojjeta. Maaloo yeroo rasmichaatti gaafadhaa.',
    ...
    howToWithdrawGuide4: 'Hayyamuufi Hiriira: Tabba "Mirkaneessi" jedhu tuqi. Gareen keenya gaaffii hunda tartiiba sa\'aatii 1-2 keessatti qulqulleessa. Hubachiisa: Maallaqa baasuun sa’aatii rasmichaatti (Guyyuu, ganama sa’aatii 3:00 AM hanga galgala sa’aatii 12:00 PM (Noon) EAT) qofa raawwatama.',
  ...
  ti: {
    ...
    withdrawalTimeLimit: 'ወግዓዊ ሰዓታት ገንዘብ ምውጻእ፡ መዓልታዊ ካብ ንጉሆ 3:00 AM ክሳብ 12:00 PM ናይ ውሽጢ ዓዲ ሰዓት (EAT)',
    withdrawalTimeError: 'ምውጻእ ገንዘብ መዓልታዊ ካብ ንጉሆ 3:00 AM ክሳብ 12:00 PM ናይ ውሽጢ ዓዲ ሰዓት (EAT) ጥራሕ እዩ ዝፍቀድ። በጃኹም ኣብ ውሽጢ ዝተፈቐደ ሰዓታት ሕተቱ።',
    ...
    howToWithdrawGuide4: 'ምርግጋጽን ተራን፡ "ውሑስ ምውጻእ ፍቐድ" ጠውቑ። ናይ ቁጽጽር ክፍሊና ንኹሎም ሕቶታት በብተራኦም ኣብ ውሽጢ 1-2 ሰዓት ከጻርዮም እዩ። መተሓሳሰቢ፡ ገንዘብ ምውጻእ ኣብ ወግዓዊ ሰዓታት ጥራሕ (መዓልታዊ ካብ ንጉሆ 3:00 AM ክሳብ 12:00 PM ናይ ውሽጢ ዓዲ ሰዓት (EAT)) ይፍቀድ።',
  ...
  so: {
    ...
    withdrawalTimeLimit: 'Saacadaha rasmiga ah ee la kala baxo: Maalin kasta, 3:00 Subaxnimo ilaa 12:00 Duhurnimo waqtiga deegaanka (EAT)',
    withdrawalTimeError: 'Kala bixista lacagta waxaa lagu xaddiday saacadaha rasmiga ah: Maalin kasta, 3:00 Subaxnimo ilaa 12:00 Duhurnimo waqtiga deegaanka (EAT). Fadlan codso inta lagu jiro saacadaha rasmiga ah.',
