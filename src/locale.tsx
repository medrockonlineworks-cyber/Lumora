...
export const translations: Record<LanguageCode, Translations> = {
  en: {
    ...
    cbeAccountNumber: 'Account Number: non non',
    ...
    howToWithdrawGuide4: 'Authorization & Queue: Click "Authorize Secure Withdrawal". Our manual audit desk processes all requests sequentially within 1-2 hours. Note: Withdrawals are processed only during official hours (Morning 3:00 to 12:00 Local Time / 9:00 AM to 6:00 PM EAT).',
  ...
  am: {
    ...
    cbeAccountNumber: 'የአካውንት ቁጥር: non non',
    ...
    howToWithdrawGuide4: 'ፈቃድ እና መስመር፡ "ገንዘብ አውጣ" የሚለውን ይጫኑ። የኦዲት ባለሙያዎቻችን በ1-2 ሰዓታት ውስጥ ያረጋግጣሉ። ማሳሰቢያ፡ ገንዘብ ማውጣት የሚቻለው በኦፊሴላዊ የሥራ ሰዓት (ከጠዋቱ 3:00 እስከ ምሽቱ 12:00 የሀገር ውስጥ ሰዓት) ብቻ ነው።',
  ...
  om: {
    ...
    cbeAccountName: 'Commercial Bank of Ethiopia (CBE)',
    cbeAccountNumber: 'Lakkoofsa Herregaa: non non',
    ...
    howToWithdrawGuide4: 'Hayyamuufi Hiriira: Tabba "Mirkaneessi" jedhu tuqi. Gareen keenya gaaffii hunda tartiiba sa\'aatii 1-2 keessatti qulqulleessa. Hubachiisa: Maallaqa baasuun sa’aatii rasmichaatti (Ganama sa’aatii 3:00 hanga galgala sa’aatii 12:00) qofa raawwatama.',
  ...
  ti: {
    ...
    cbeAccountName: 'Commercial Bank of Ethiopia (CBE)',
    cbeAccountNumber: 'ቁጽሪ ሒሳብ: non non',
    ...
    howToWithdrawGuide4: 'ምርግጋጽን ተራን፡ "ውሑስ ምውጻእ ፍቐድ" ጠውቑ። ናይ ቁጽጽር ክፍሊና ንኹሎም ሕቶታት በብተራኦም ኣብ ውሽጢ 1-2 ሰዓት ከጻርዮም እዩ። መተሓሳሰቢ፡ ገንዘብ ምውጻእ ኣብ ወግዓዊ ሰዓታት ጥራሕ (ካብ ንጉሆ 3:00 ክሳብ ምሸት 12:00 ናይ ውሽጢ ዓዲ ሰዓት) ይፍቀድ።',
  ...
  so: {
    ...
    cbeAccountName: 'Commercial Bank of Ethiopia (CBE)',
    cbeAccountNumber: 'Koontada: non non',
